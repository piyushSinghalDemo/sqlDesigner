...
SQL.Relation = function(owner, row1, row2) {
	...
	if (this.owner.vector) {
		...
		var t1 = this.row1.data.ai
		var t2 = this.row2.data.ai
		console.log(t1+ ">>>>t2 " + t2);
		var svgNode = document.createElementNS('http://www.w3.org/2000/svg', 'svg');

		var defs = document.createElementNS(this.owner.svgNS, 'defs');
    var marker = document.createElementNS(this.owner.svgNS, 'marker');
    ...
    marker.setAttribute('orient', 'auto');
		// marker.setAttribute("transform", "rotate(180)");
		var line = document.createElementNS(this.owner.svgNS, "path");
		// line.setAttribute("transform", "rotate(30, 5, 0)");
		// line.setAttribute("transform", "translate(-5, 0)");
		line.setAttribute('d', 'M 0 0 L 10 5 L 0 10 z');
		...
		// img.setAttributeNS('http://www.w3.org/1999/xlink','href','https://d2slcw3kip6qmk.cloudfront.net/marketing/pages/chart/ER-diagram-symbols-and-meaning/ERD_notation-416x315.PNG');
		// img.setAttributeNS(null,'x','0');
		// img.setAttributeNS(null,'y','0');


		marker.appendChild(line);
		svgNode.appendChild(marker);
		...
		if(t2)
			path.setAttribute('marker-start', 'url(#Triangle)');
		...
		console.log(svgNode);
		console.log(path);
		this.owner.dom.svg.appendChild(marker);
		this.owner.dom.svg.appendChild(path);
		console.log(this.owner.dom.svg);
		this.dom.push(path);
	} else {
		for (var i=0;i<3;i++) {
