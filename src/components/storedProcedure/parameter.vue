  ...
  <v-container grid-list-md>
    ...
    <v-layout row wrap>
      <v-flex xs6  offset-xs3>
        <v-select :items="selectTable" v-model="tableObj.storedProcedure.name"
            :loading="loading" :search-input.sync="search" @selected="getParams"
...
export default {
  data() {
      return {
        ...
        createCopy : false,
        allDbTablesCopy : [],
        selectTable:[{'name':'dummy','stepId':'1'}],
      }
    },
    props: ['tableObj'],
    mounted() {
